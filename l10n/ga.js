OC.L10N.register(
    ...
    "Discourse read notifications" : "Fógraí léite dioscúrsa",
    ...
    "Use the button below to trigger the custom protocol handler registration. If no prompt appears, make sure it is not already registered." : "Úsáid an cnaipe thíos chun clárú láimhseálaí prótacail saincheaptha a spreagadh. Mura dtaispeántar leid, cinntigh nach bhfuil sé cláraithe cheana féin.",
    "Register protocol handler" : "Clárú láimhseálaí prótacail",
    ...
    "For example, https://help.nextcloud.com" : "Mar shampla, https://help.nextcloud.com",
    ...
    "Protocol handler registration requires a secure context (https) or is not supported by your browser" : "Éilíonn clárú láimhseálaí prótacail comhthéacs slán (https) nó ní thacaíonn do bhrabhsálaí leis",
